...
import { renderStaticBoard, BOARD_PLAYBACK_STEP_MS, toggleInspectorFlip } from "./board.js";
...
document.getElementById("treeInspectorFlip")?.addEventListener("click", () => { toggleInspectorFlip(); refreshTreeInspector(); });
